...
Original file is located at
    https://colab.research.google.com/drive/10OpoqW5Pq4T2uVGx8QPrzeCbZLPm-_07

***Designing a Neural network to classify the dataset into 2 categories : cancerous and malignant***
"""
...
plt.hist(dataset['Mean Radius'], bins=20, color='red', edgecolor='black')
